...
public class Pause2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        imageView.setImageResource(R.mipmap.a03);
        ...
        imageView.setOnTouchListener(new OnSwipeTouchListener(Pause2.this) {
            ...
            public void onSwipeRight() {
                ...
                ttsManager.initQueue(text);
                Intent intent_in = new Intent(de.baumann.sieben.Pause2.this, Pause.class);
                startActivity(intent_in);
                overridePendingTransition(0, 0);
                isCanceled = true;
                finish();
            ...
            public void onSwipeLeft() {
                ...
                ttsManager.initQueue(text);
                Intent intent_in = new Intent(de.baumann.sieben.Pause2.this, Pause3.class);
                startActivity(intent_in);
                overridePendingTransition(0, 0);
                isCanceled = true;
                finish();
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.action_license) {
            ...
            final AlertDialog d = new AlertDialog.Builder(Pause2.this)
