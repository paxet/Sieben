...
public class Pause10 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        imageView.setOnTouchListener(new OnSwipeTouchListener(Pause10.this) {
            ...
            public void onSwipeRight() {
                ...
                ttsManager.initQueue(text);
                Intent intent_in = new Intent(de.baumann.sieben.Pause10.this, Pause9.class);
                startActivity(intent_in);
                overridePendingTransition(0, 0);
                isCanceled = true;
                finish();
            ...
            public void onSwipeLeft() {
                ...
                ttsManager.initQueue(text);
                Intent intent_in = new Intent(de.baumann.sieben.Pause10.this, Pause11.class);
                startActivity(intent_in);
                overridePendingTransition(0, 0);
                isCanceled = true;
                finish();
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.action_license) {
            ...
            final AlertDialog d = new AlertDialog.Builder(Pause10.this)
