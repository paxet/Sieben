...
public class Pause6 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        timer = new CountDownTimer(millisInFuture,countDownInterval){
            ...
            public void onFinish(){
                ...
                Intent intent_in = new Intent(de.baumann.sieben.Pause6.this, MainActivity7.class);
        ...
        imageView.setOnTouchListener(new OnSwipeTouchListener(Pause6.this) {
            ...
            public void onSwipeRight() {
                Intent intent_in = new Intent(de.baumann.sieben.Pause6.this, Pause5.class);
                startActivity(intent_in);
                overridePendingTransition(0, 0);
                isCanceled = true;
                finish();
            ...
            public void onSwipeLeft() {
                Intent intent_in = new Intent(de.baumann.sieben.Pause6.this, Pause7.class);
                startActivity(intent_in);
                overridePendingTransition(0, 0);
                isCanceled = true;
                finish();
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.action_license) {
            ...
            final AlertDialog d = new AlertDialog.Builder(Pause6.this)
